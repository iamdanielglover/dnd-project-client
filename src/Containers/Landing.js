      ...
      <div>
        ...
        <Card id="card-border">
          <Card.Content textAlign={"center"}>
            ...
            <br/>
            <Button id="add-font" color="black" style={{float: "center"}} onClick={() => this.props.history.push("/create-character")}>Create</Button>
          </Card.Content>
        </Card>
        <Card id="card-border">
          <Card.Content textAlign={"center"}>
            ...
            <br/>
            <Button id="add-font" color="black" style={{float: "center"}} onClick={() => this.props.history.push("/view-characters")}>View</Button>
          </Card.Content>
        </Card>
        </Card.Group>
      </div>
